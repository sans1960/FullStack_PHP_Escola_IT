...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2021 a las 14:17:29
...
CREATE TABLE `pedido` (
  ...
  `hamburguesas` int(11) DEFAULT NULL,
...
INSERT INTO `pedido` (`id`, `cliente_id`, `fecha`, `reparto_id`, `tienda_id`, `pizzas`, `hamburguesas`, `bebidas`, `total`) VALUES
(1, 1, '2021-03-02 14:14:32', 1, NULL, 1, 1, 1, '21.50');
