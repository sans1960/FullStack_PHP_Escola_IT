                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('equipos.update',$equipo->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="name" class="block mt-1 w-full" type="text" name="nombre" value="{{$equipo->nombre}}"  />
                                @error('nombre')
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="poblacion" class="block mt-1 w-full" type="text" name="poblacion" value="{{$equipo->poblacion}}" />
                                @error('poblacion')
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mt-4">
                            ...
                            <x-input id="email" class="block mt-1 w-full" type="email" name="email" value="{{$equipo->email}}" />
                                @error('email')
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="escudo" class="block mt-1 w-full" type="file" name="escudo"  value="{{$equipo->escudo}}"/>
                        </div>
                    </div>
